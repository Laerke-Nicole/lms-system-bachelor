        ...
        <div class="col-12 col-lg-5">
            <div class="row booking-sidebar">
                ...
                <div class="order-1 order-lg-2 alert alert-primary small" role="alert">
                    Missing employees? <a href="{{ route('register') }}" class="fw-semibold text-decoration-underline">Register new employees here</a>. Or make sure they've given consent for you to access their information (via their profile).
                </div>
            </div>
        </div>
    </div>
