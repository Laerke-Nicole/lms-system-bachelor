@if( auth()->user()->role === 'admin' )
    <x-blocks.mmenu-dropdown title="Clients" icon="bi bi-building">
        ...
        <li><x-elements.link title="Participants" href="{{ route('users.index') }}" icon="bi bi-dot"></x-elements.link></li>
    </x-blocks.mmenu-dropdown>
@elseif( auth()->user()->role === 'leader' )
    <li><x-elements.link title="Employees" href="{{ route('users.index') }}" icon="bi bi-people"></x-elements.link></li>
@endif
